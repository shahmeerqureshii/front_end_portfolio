...
const socialLinks = [
  ...
  },
  {
    ...
    subText: "@__karasahin",
    icon: Instagram,
    url: "https://www.instagram.com/__karasahin/",
    color: "#E4405F",
  ...
  },
  {
    ...
    icon: Linkedin,
    url: "https://www.linkedin.com/in/shahmeersohailvisuals/",
    color: "#0A66C2",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@shahmeerqureshii",
    icon: Github,
    url: "https://github.com/shahmeerqureshii",
    color: "#ffffff",
  ...
  },
  {
    name: "Discord",
    displayName: "Discord",
    subText: "Join my Discord server",
    icon: ExternalLink,
    url: "https://discord.gg/wAHwaTd9E5",
    color: "#5865F2",
