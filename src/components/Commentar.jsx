...
const Komentar = () => {
    ...
    useEffect(() => {
        ...
        return onSnapshot(q, (querySnapshot) => {
                ...
                const pinned = commentsData.find(c => c.pinned);
                const others = commentsData.filter(c => !c.pinned);
                const limit = '';
                const othersSlice = others.slice(0, pinned ? limit - 1 : limit);
                const finalComments = pinned ? [pinned, ...othersSlice] : othersSlice;
