        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Experienced Frontend Engineer with 3+ years in React, JavaScript, and Tailwind CSS. I specialize in building clean, responsive, and user-centric web applications that transform complex challenges into seamless, high-performance, and visually engaging digital experiences.
            </p>
            ...
            >
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                "Turning design concepts into functional digital solutions."
              </blockquote>
            </div>
