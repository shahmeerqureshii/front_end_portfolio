...
const WORDS = ["Frontend Engineer", "Visual Web Developer", "UI-Driven Frontend Developer"];
const TECH_STACK = ["ReactJS", "JavaScript", "Bootstrap", "TailwindCSS"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/shahmeerqureshii" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/shahmeersohailvisuals/" },
  { icon: Instagram, link: "https://www.instagram.com/__karasahin/" }
];
